...
function trailer() {
  return (
    <div className='flex flex-col gap-4 w-full h-85 pl-27 pr-4 pb-8'>
      <img src={tailor} alt="tailor" width={300} height={200} className='w-full' />
      <div className='flex justify-between items-center w-full border-b border-gray-200 h-10 text-sm'>
      ...
      <div className='flex flex-col gap-4 w-full py-2 text-gray-500 text-[14px]'>
        <h2 className='text-dark font-semibold text-2xl py-4'>Who this course is for:</h2>
      ...
      <div className='flex flex-col gap-4 w-full py-2 text-gray-500 text-[14px]'>
        <h2 className='text-dark font-semibold text-2xl py-4'>Course requirements</h2>
