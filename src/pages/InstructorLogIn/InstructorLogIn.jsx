  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full">
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center items-center px-6 sm:px-12 md:px-20 py-12">
        <h1 className="text-3xl font-bold text-primary mb-7">Instructor Portal</h1>
        <h2 className="text-2xl font-semibold mb-6 text-center text-dark">Login as Instructor</h2>
            ...
            <Form className="space-y-5 w-full max-w-sm">
              <div className="relative">
                ...
                <Field
                  ...
                  className={`pl-10 pr-4 py-2 w-full border ${
                    errors.email && touched.email ? "border-red-500" : "border-secondary"
              ...
              <div className="relative">
                ...
                <Field
                  ...
                  className={`pl-10 pr-10 py-2 w-full border ${
                    errors.password && touched.password ? "border-red-500" : "border-secondary"
                  } rounded-md outline-none focus:ring-2 focus:ring-primary`}
                />
                {showPassword ? (
                  <Eye className="absolute right-3 top-3.5 text-light cursor-pointer" size={20} onClick={() => setShowPassword(false)} />
                ) : (
                  <EyeOff className="absolute right-3 top-3.5 text-light cursor-pointer" size={20} onClick={() => setShowPassword(true)} />
                )}
              ...
              <div className="text-sm text-dark">
                ...
                <label className="flex items-center gap-2 text-gray-500">
                  <Field type="radio" name="role" value="instructor" checked disabled />
                  Instructor
                </label>
              </div>
              ...
              <button type="submit" className="w-full bg-primary text-white py-2 rounded-md font-semibold hover:brightness-90 transition">
                LOG IN
              </button>
      ...
      <div className="w-full lg:w-1/2 bg-primary flex items-center justify-center py-12">
        <img src="/Login.png" alt="Login Illustration" className="w-3/4 h-3/4 object-contain rounded-full" />
      </div>
    </div>
  );
};
