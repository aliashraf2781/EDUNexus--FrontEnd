  ...
  useEffect(() => {
    const fetchCourse = async () => {
      const response = await fetch(
        `https://rat-intent-hideously.ngrok-free.app/api/courses/${id}`,
        {
          method: "GET",
          headers: {
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4 w-full items-center lg:pl-27 px-4 pb-8">
            <div className="flex flex-col gap-4 w-full py-2 text-gray-500 text-[14px]">
              <h2 className="text-dark font-semibold text-2xl py-2">
                Course Info
              </h2>
              <p>
              ...
              <p>
                <strong>Rating:</strong> {course.rate}/5
              </p>
              <p>
              ...
              <p>
                <strong>Quizzes:</strong> {course.quizzes.length}
              </p>
            </div>
        ...
        <div className="max-w-screen-xl my-3">
          ...
          <div className="md:px-27 px-7 py-7 flex flex-col gap-6">
            <div className="flex gap-3 justify-between items-start">
              ...
              >
                <span className=" text-primary text-md font-semibold hidden md:block">
                  View All
                </span>
